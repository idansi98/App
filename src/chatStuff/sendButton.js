...
function SendButton({ isSmall, inputText, setMessageJustSent, setInputText , setRecorder, recorder}) {
  ...
  if (recorder ===null) {
    ...
    // if recording
    return (
    <button id="Send" onClick={sendAudioMessage} type="button" className="smallChatButton btn btn-info">
