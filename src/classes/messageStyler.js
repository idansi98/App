const leftStyle = "blueMessage messageRestrictWidth bg-primary p-2 mt-2 mr-5 shadow-sm text-white float-left rounded"
const rightStyle ="greenMessage messageRestrictWidth bg-success p-2 mt-2 mr-5 shadow-sm text-white float-right rounded rightMessage"
